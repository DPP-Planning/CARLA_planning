...
point_b = carla.Location(point_b_spawn.location) # destination
...
try:
    ...
    vehicle_3 = world.spawn_actor(vehicle_bp_2, point_e_spawn) #spawn blocker
    ...
    while not controller.done():
        ...
        if i > 7 and not flag:
             #obstacle_controller = DPP_Controller(vehicle_3, point_b, spawn_points)
    ...
    for v in vehicles:
        if v.is_alive:
            destroyed_successfully = v.destroy()
